...
class PlayerControlMenuBuilder
  ...
  def build_player_controls_selection_menu
    ...
    menu[:label_text] = args[:label_text] if args[:label_text]
    menu_builder.build menu
  end
  ...
  def build_player_control_setup_menu(opts)
    ...
    log menu_opts
    stage.create_actor :menu, menu_opts
  end
  ...
  def build(controls_data) # controls)
    ...
    player_menus = [p1_control_menu, p2_control_menu, p3_control_menu, p4_control_menu]

    player_menus

    # player_controls_menu = menu_builder.build(controls_data, 
    #                                           p1_control_menu,
    #                                           p2_control_menu,
    #                                           p3_control_menu,
    #                                           p4_control_menu,
    ...
    # device_selection_menu = stage.create_actor :menu, label_text: "Input Device",
    #   x: player_controls_menu.x+5, y: player_controls_menu.y+player_controls_menu.h-30, h: 30, w: 300 

    # control_setting_menu = stage.create_actor :menu, label_text: "Other",
